...
import com.example.aloha.databinding.ItemContainerReceivedMessageBinding;
import com.example.aloha.databinding.ItemContainerSentMessageBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    static class ReceivedMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        void setData(ChatMessage chatMessage, String receiverProfileImage){
            binding.textMessage.setText(chatMessage.message);
            binding.textDateTime.setText(chatMessage.dateTime);
            Log.d("TAG_mess", "setData: "+chatMessage.message);
            Log.d("TAG_dateTime", "setData: "+chatMessage.dateTime);
            Log.d("TAG_image", "setData: "+receiverProfileImage);
